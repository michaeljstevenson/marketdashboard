// Serves the cash-conversion-cycle snapshot computed by
// scheduled-cash-conversion-cycle-background.js and stored in Netlify
// Blobs. This function makes no Alpha Vantage calls itself — it just reads
// the pre-computed blob.

const { getCashConversionCycleStore, BLOB_KEY } = require("./cash-conversion-cycle-blob-store");
