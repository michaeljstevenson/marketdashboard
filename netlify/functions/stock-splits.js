// Serves the stock-split snapshot (recent S&P 500 split events, with
// forward market-relative excess returns where computable) built weekly by
// scheduled-splits-background.js and stored in Netlify Blobs. This
